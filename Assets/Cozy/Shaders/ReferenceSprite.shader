Shader "Cozy/ReferenceSprite"
{
    Properties
    {
        ...
        _BackgroundThresholds ("Background key thresholds", Vector) = (0.015,0.045,0,0)
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i):SV_Target
            {
                ...
                c.a *= smoothstep(_BackgroundThresholds.x,_BackgroundThresholds.y,distance(c.rgb,background));
                return c*i.color;
            }
            ENDCG
        }
